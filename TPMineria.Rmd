...
Se toman las reglas ordenandas por confianza para analizar y eliminar las reglas redundantes. Se puede observar en el inspect que las reglas 2 y 3 son similares a la regla 1 pero más específicas, por esto deben ser eliminadas para el análisis.
Se elimianan las reglas redundantes y se imprimen las primeras 8.

```{r size = 'scriptsize'}
top.confidence <- top.confidence[!is.redundant(top.confidence)]
