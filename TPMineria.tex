...
Calcula duración como Fecha de Resolución menos Fecha de inicio,
generamos una nueva columna \enquote{duracion} y mostramos un fragmento
de la nueva tabla en la siguiente gráfica.
...
Eliminamos filas que tienen datos inválidos de fecha (datos nulos o
...
* Rápido: duración menor al cuartil 25\% * Normal: duración entre el
cuartil 25\% y el 75\%. * Demorado: duración mayor al cuartil 75\%.
